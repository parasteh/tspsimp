...
from siam_swa_n_average import update_bn
...
if __name__ == '__main__':
    ...
    # test_set = problem.make_dataset(size=50,
    #                                    num_samples=1000,
    #                                    filename=None)
    TRAINED_DIRECORY = "./outputs/tsp_100/run_name_20220430T123549/epoch-swa-119.pt"
    ...
    for i in range(2):
        training_dataset = problem.make_dataset(size=opts.graph_size, num_samples=opts.epoch_size)
        training_dataloader = DataLoader(training_dataset, batch_size=opts.batch_size)
        update_bn(training_dataloader, model_swa, problem, opts)
